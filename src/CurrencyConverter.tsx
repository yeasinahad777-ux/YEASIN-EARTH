	...
	return (
		<div className="relative shrink-0 min-w-[140px]" ref={dropdownRef}>
			...
			>
				...
				/>
				<span className="font-bold text-[var(--text-main)] text-lg md:text-xl shrink-0">
					{selectedOption.code}
				</span>
				<span className="text-[var(--text-muted)] text-sm truncate hidden sm:block max-w-[100px]">
...
export default function CurrencyConverter({ onClose }: CurrencyConverterProps) {
	const [currencies, setCurrencies] =
		useState<CurrencyInfo[]>(FALLBACK_CURRENCIES);
	...
	const calculateConvertedAmount = () => {
		if (!rates[fromCurrency] || !rates[toCurrency] || isNaN(Number(amount)))
			return "0.00";
						...
						<div className="space-y-6">
							...
							<div className="flex flex-col lg:flex-row items-center gap-4 relative w-full mb-8">
								...
								<div className="w-full flex-1 bg-[var(--bg)] rounded-2xl border-2 border-[var(--border)] hover:border-blue-400 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 transition-all p-4">
									<label className="block text-xs font-bold text-[var(--text-muted)] mb-3 uppercase">
										হতে (From)
									</label>
								...
								<div className="w-full flex-1 bg-[var(--bg)] rounded-2xl border-2 border-[var(--border)] hover:border-blue-400 transition-all p-4">
									...
									<div className="flex items-center justify-between gap-4">
										<div
											className="w-1/2 min-w-[80px] text-3xl sm:text-4xl font-black text-[var(--text-main)] truncate overflow-hidden"
											title={calculateConvertedAmount()}
										>
							...
							<div className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 px-6 py-4 rounded-2xl border border-blue-100 dark:border-blue-900/40 text-center font-medium shadow-sm mb-6">
								১ <span className="font-bold">{fromCurrency}</span> ={" "}
								...
								<div className="flex items-center justify-between mb-4">
									<div className="flex items-center gap-2">
										...
										<h3 className="font-bold text-lg text-[var(--text-main)]">
											...
											<span className="text-xs ml-2 font-normal text-blue-500 bg-blue-50 dark:bg-blue-900/30 px-2 py-0.5 rounded-full border border-blue-200 dark:border-blue-800">
												Beta
											</span>
										</h3>
									</div>
									{!insight && !isLoadingInsight && (
										...
										>
											<img
												src="https://www.gstatic.com/lamda/images/sparkle_resting_v2_darkmode_2cbc7df27f9e1tx.gif"
												alt="AI"
